...
mixin _$AppSettingsState {
 ...
 Map<String, Map<String, String>> get translations; String get languageCode;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AppSettingsState&&const DeepCollectionEquality().equals(other.translations, translations)&&(identical(other.languageCode, languageCode) || other.languageCode == languageCode));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(translations),languageCode);

@override
String toString() {
  return 'AppSettingsState(translations: $translations, languageCode: $languageCode)';
}
...
@useResult
$Res call({
 Map<String, Map<String, String>> translations, String languageCode
});
...
/// Create a copy of AppSettingsState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? translations = null,Object? languageCode = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Map<String, Map<String, String>> translations,  String languageCode)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AppSettingsState() when $default != null:
return $default(_that.translations,_that.languageCode);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Map<String, Map<String, String>> translations,  String languageCode)  $default,) {final _that = this;
switch (_that) {
case _AppSettingsState():
return $default(_that.translations,_that.languageCode);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Map<String, Map<String, String>> translations,  String languageCode)?  $default,) {final _that = this;
switch (_that) {
case _AppSettingsState() when $default != null:
return $default(_that.translations,_that.languageCode);case _:
  return null;
...
class _AppSettingsState extends AppSettingsState {
  const _AppSettingsState({final  Map<String, Map<String, String>> translations = const {}, this.languageCode = 'en'}): _translations = translations,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AppSettingsState&&const DeepCollectionEquality().equals(other._translations, _translations)&&(identical(other.languageCode, languageCode) || other.languageCode == languageCode));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_translations),languageCode);
...
/// Create a copy of AppSettingsState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? translations = null,Object? languageCode = null,}) {
